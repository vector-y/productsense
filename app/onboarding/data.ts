...
export const analysisContent: AnalysisContent[] = [
	// Comparative analysis
	{
		...
		analysis: '<strong>How quickly does each app deliver something meaningful to a new user?</strong>\n\n<u>Notion</u> is the quickest to deliver meaningful tips on the core functionality of the app, with the most concise but information rich onboarding experience. The app even introduces a new initiative the company is pushing for with their AI assistant which shows a lot of immediate value to help users set up their workspace(s).\n\nCompared to <u>Notion</u>, both <u>Instagram</u> and <u>Venmo</u> take a while to get into the meaningful functionality. This is because of the higher risks associated with their respective platforms. <u>Venmo</u> has legal obligations to make sure users know about their fee policies. On the other hand, <u>Instagram</u> has to make sure the user agrees to their terms and policies because of the potentially turbulent nature of social media platforms.\n\n<strong>What counts as "value" in each context?</strong>\n\n"Value" for <u>Instagram</u> looks like being able to connect with friends or following accounts that interest you to develop a deeply personal algorithm on your preferences. <u>Venmo</u> is an interesting case because it usually doesn\'t have much upfront value. Creating an account on <u>Venmo</u> usually is in preparation for payments later, not in the exact moment (ideally). That being said, once the payments do need to be exchanged, <u>Venmo</u>\'s value skyrockets since there aren\'t payment methods as widespread with their platform\'s reach. <u>Notion</u>\'s value is simple and quick with a short and meaningful onboarding that transports users straight to an assistant to aid users with their productivity.',
		screenshots: [
			{
	...
	},
	{
		...
		analysis: '<u>Venmo</u> must perform a delicate balancing act: appearing casual and social enough to differentiate from traditional banking apps, while establishing sufficient trust for users to link their bank accounts. The visual design uses friendly blues and clean interfaces that feel approachable but professional, avoiding both the stuffiness of banking apps and the excessive playfulness that might undermine trust.\n\nCopy strikes a conversational tone while being precise about security. Phrases like "Pay anyone" and "Split bills seamlessly" emphasize ease, while security explanations use clear, non-technical language. The app leverages social proof aggressively: "12 million+ users," friend connections, and transaction activity all signal that <u>Venmo</u> is established and trustworthy. Privacy controls are prominent, allowing users to make transactions private, addressing concerns about financial information sharing without hiding the social features that differentiate <u>Venmo</u>.',
		screenshots: [
			{
				src: '/Onboarding/Venmo/Venmo (iOS).png',
	...
	},
	{
		appId: 'venmo',
		dimensionId: 'business-model',
		analysis: '<u>Venmo</u>\'s business model (transaction fees for business payments and instant transfers) influences onboarding toward high-frequency, social transaction patterns. The emphasis on friend connections and the social feed encourages casual, frequent payments rather than viewing <u>Venmo</u> as a one-off tool. This habitual usage pattern drives volume even if individual transaction fees are small.\n\nThe onboarding downplays merchant payments and instant transfer fees, instead highlighting free peer-to-peer transfers to reduce initial friction. Revenue-generating features (instant transfer, business payments) are introduced later, after users are committed to the platform. The focus on linking debit cards alongside bank accounts supports the instant transfer business, while social features encourage network effects that increase platform value. <u>Venmo</u>\'s parent company (PayPal) also benefits from data on spending patterns, making user acquisition valuable beyond direct transaction fees.',
		screenshots: [
			{
				src: '/Onboarding/Venmo/Venmo (iOS).png',
	...
	},
	{
		appId: 'venmo',
		dimensionId: 'friction-flow',
		analysis: '<u>Venmo</u> faces unavoidable regulatory friction (identity verification, bank linking) that would sink most consumer apps. The app manages this by breaking the onboarding into clear stages with different friction profiles. Account creation is quick (email, password, phone verification), bank linking is presented as a straightforward next step, and full identity verification is framed as "unlocking higher limits" rather than a requirement.\n\nFlow is optimized within regulatory constraints: instant bank account linking via credentials is positioned before the slower micro-deposit method, and debit card additions are streamlined. The app uses waiting periods productively—while bank verification completes, users can explore the social feed and understand the product. <u>Venmo</u> also reduces perceived friction through clear progress indicators and time expectations: "This usually takes 2-3 business days" rather than vague waiting. The result is an onboarding that acknowledges and works with necessary friction rather than fighting against it or hiding it.',
		screenshots: [
			{
				src: '/Onboarding/Venmo/Venmo (iOS).png',
